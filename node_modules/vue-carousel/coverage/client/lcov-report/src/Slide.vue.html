...
export default {
  name: "slide",
  props: ["title"],
  da<span class="missing-if-branch" title="else path not taken" >E</span>ta() {
    return {<span class="fstat-no" title="function not covered" ></span>
      wi<span class="cstat-no" title="statement not covered" >dth: null</span>
    };
  },
  inject: ["carousel"],
  mounted() {<span class="branch-0 cbranch-no" title="branch not covered" ></span>
    if (!this.$isServer) {
...
&nbsp;
    ...
    /**
     * `isCenter` describ<span class="fstat-no" title="function not covered" >es whether </span>a slide is in the center of all visible slides
     * if perPage is a<span class="cstat-no" title="statement not covered" >n even number, we quit</span>
     * @return {Boo<span class="cstat-no" title="statement not covered" >lean}</span>
     */
    is<span class="cstat-no" title="statement not covered" >Center() {</span>
      co<span class="cstat-no" title="statement not covered" >nst { perPage } = this.carousel;</span>
...
<span class="missing-if-branch" title="else path not taken" >E</span>     */
    isAdjustableHeight() {<span class="branch-0 cbranch-no" title="branch not covered" ></span>
      const { adjustableHeight } = this.carousel;<span class="branch-1 cbranch-no" title="branch not covered" ></span>
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Fri Dec 21 2018 07:57:45 GMT-0500 (EST)
</div>
</div>
