...
function useMutation(document, options) {
    ...
    var called = composition_api_1.ref(false);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        else if (composition_api_1.isRef(document)) {
                        ...
                        else if (composition_api_1.isRef(options)) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, client.mutate(__assign(__assign(__assign({ mutation: currentDocument }, currentOptions), overrideOptions), { variables: __assign(__assign({}, variables || {}), currentOptions.variables || {}) }))];
                    case 2:
                        result = _a.sent();
                        loading.value = false;
